...
print("-|"*iterations)
print(f"Execution time no-cache: {(end_1 - start_1)*(10**6):0.2f} microseconds. Execution time using cache:{(end_2 - start_2)*(10**6):0.2f} microseconds")
print(f"time delta: {((end_1 - start_1)-(end_2 - start_2))*10**6:0.2f} microseconds")
print(f"Cashed access faster on {iterations} iterations  {((end_1 - start_1)/(end_2 - start_2)):.0f} times")  
